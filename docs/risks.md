...
| 3 | `SPK-05` | `R-AI-01`, `R-AI-02` | Eval требует репрезентативных отзывов или согласованного substitute | `SPK-02` либо допустимые samples | Blocked — `Ask`, needed by `G2` |
...
**Итог:** `RSK-01`, `SPK-01` и `SPK-04` завершены. Календарная модель принята с ограничениями; Metacritic-зависимая ветка остаётся заблокирована `SPK-01: Ask`. Независимых задач `Ready` больше нет.
