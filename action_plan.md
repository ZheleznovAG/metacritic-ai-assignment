...
| [SIM-VER-01](implementation_plan.md#sim-ver-01) | IMP-05, IMP-06 | base | In progress | [Review](docs/requirements/sim_ver_01_review.md): DB/card/navigation реализованы; 292 application tests и 56 fixture browser checks PASS, все 14 frozen cases сохранены. Ожидаются candidate CI и публичные deployment/source-refresh/navigation evidence. IMP-06 evidence-коммит `fc61dc0` прошёл [CI 34868474047](https://github.com/ZheleznovAG/metacritic-ai-assignment/actions/runs/34868474047). |
