...
| Поле | Значение |
|---|---|
| Версия плана | Discovery baseline 0.2 |
| Дата | 2026-09-04 |
...
| Активная стадия | 2 — снятие критических неизвестных; следующая задача `SPK-01` |
| Реализация | Не начата |
| Текущие блокеры | Дедлайн, бюджет и доступы не заданы; это явно зарегистрировано и не блокирует начало risk discovery |
...
`RSK-01` — создать и приоритизировать реестр рисков. До отдельной команды на выполнение эта и последующие задачи стадии 2 не запускаются.
