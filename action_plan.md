...
| [SIM-EVAL-01](implementation_plan.md#sim-eval-01) | G3 | base | Blocked | [Oracle 1.0.0 / Ask](docs/requirements/sim_eval_01_review.md): 14 synthetic cases, nDCG@5 mean ≥0.90 / each ≥0.80, 8 hard invariants; 14 meta-tests PASS. Нужен ответ владельца о принятии frozen oracle, needed-by G4 до IMP-06. |
