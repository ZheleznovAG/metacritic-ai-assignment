...
- Bonus scope: `pending`.
- IMP-01, IMP-02, IMP-03, REV-EVAL-01, IMP-04 verified. Последний завершённый цикл — IMP-04 (durable review collection + AI review-summary contour).
- Текущий blocker: нет. IMP-05 разблокирован (IMP-04 verified); SIM-EVAL-01 остаётся доступен независимо.
