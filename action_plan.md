...
- Bonus scope: `pending`.
- IMP-01, IMP-02, IMP-03, REV-EVAL-01 verified. Последний завершённый цикл — REV-EVAL-01 (владелец принял selection-oracle 2026-09-12).
- Текущий blocker: нет. IMP-04 разблокирован (REV-EVAL-01 принят); SIM-EVAL-01 остаётся доступен независимо.
