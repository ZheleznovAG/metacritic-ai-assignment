...
| Поле | Значение |
|---|---|
| Версия плана | Discovery baseline 0.1 |
| Дата | 2026-09-04 |
...
| Завершённая стадия | 0 — Intake |
| Активная стадия | Не начата; следующая — 1, формализация |
| Реализация | Не начата |
| Текущие блокеры | Дедлайн, бюджет, доступы и часть продуктовых трактовок не заданы; они включены в discovery |
...
| 1. Формализация | Реестр требований, допущений и критериев приёмки | `G1` | `Planned` |
| 2. Снятие неизвестности | Реестр рисков и результаты Must-spikes | `G2` | `Planned` |
...
- **Тип:** Discovery.
- **Связи:** `RUN-01`, `SEL-01–SEL-03`, `DATA-01–DATA-03`, `AI-01–AI-03`, `UI-01–UI-05`, `SIM-01–SIM-02`, `YT-01`, `OPS-01–OPS-02`, `DEL-01–DEL-04`.
...
- **Evidence:** отчёт ворот `G1` в реестре требований.
...
- [ ] Каждый явный пункт `assignment.md` имеет стабильный ID и источник.
- [ ] Must, Bonus, неявно необходимое свойство и Improvement не смешаны.
- [ ] Существенные неоднозначности отвечены или явно приняты как допущения.
- [ ] У каждого Must есть критерий, оракул, способ проверки и ожидаемый evidence.
- [ ] Формулировки не навязывают стек или архитектуру без основания.
...
- [ ] Календарные переходы и восстановление однозначно описаны.
...
- **Тип:** Implementation / Verification.
- **Связи:** `RUN-01`, `SEL-01–SEL-03`, `DATA-01`.
...
- **Связи:** `SEL-01–SEL-02`, `DATA-02–DATA-03`.
...
- **Тип:** Verification / Hardening.
- **Связи:** `RUN-01`, `SEL-01–SEL-03`, `DATA-01`, `AI-03`.
...
- **Тип:** Verification / Hardening.
- **Связи:** `RUN-01`; позднее `OPS-02`, если Bonus выбран.
...
- **Тип:** Implementation / Verification.
- **Связи:** `RUN-01`, `DEL-02`; подготовка к `OPS-01–OPS-02`.
...
| `SIM-01–SIM-02` | `IMP-06` | `IMP-07`, `PUB-03`, `REL-01` |
...
### Ближайшее действие после утверждения этого workflow

`FOR-01` — зафиксировать недостающие рамки проекта. До отдельной команды на выполнение эта и последующие задачи остаются в статусе `Planned`.
