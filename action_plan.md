...
| [IMP-04](implementation_plan.md#imp-04) | IMP-03, REV-EVAL-01 | base | Ready | [R03–R06](docs/requirements/imp_04_snapshot_correction.md) и [все AI/collection/queue corrections](docs/requirements/implementation_corrections_batch.md) проверены: local/Linux suite 261 tests. Замечания к коду устранены; dependency IMP-03 выполнена. Следующий цикл: актуальное provider/collection public evidence на исправленном коде. Historical: [review/summary evidence](docs/requirements/imp_04_review.md). |
