...
| [IMP-05](implementation_plan.md#imp-05) | IMP-04 | base | Ready | [R12/R17/R21 corrections](docs/requirements/implementation_corrections_batch.md): local/Linux suite, browser/CSS/mobile screenshots пройдены. Замечания к коду устранены; dependency IMP-04 выполнена. Следующий цикл: актуальное public UI evidence на исправленном коде. Historical: [UI evidence](docs/requirements/imp_05_review.md). |
