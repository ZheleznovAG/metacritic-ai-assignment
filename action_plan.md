...
| [IMP-06](implementation_plan.md#imp-06) | SIM-EVAL-01, IMP-02 | base | In progress | [Review и comparison](docs/requirements/imp_06_review.md): genre Jaccard 1.0.0 прошёл frozen oracle (mean/floor 1.0, все invariants); weighted candidate отвергнут. Genre DTO/storage/provenance и миграция проверены; 284 local application tests PASS. Candidate ожидает hosted CI. |
