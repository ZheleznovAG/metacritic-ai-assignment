...
| [IMP-03](implementation_plan.md#imp-03) | IMP-02 | base | Ready | [R16/R20/R19 corrections](docs/requirements/implementation_corrections_batch.md) и [Discovery R02/R15](docs/requirements/imp_03_discovery_correction.md) подтверждены; dependency IMP-02 выполнена. Следующий цикл: повторная проверка scheduler и актуальное public run evidence на исправленном коде. |
...
| [SIM-EVAL-01](implementation_plan.md#sim-eval-01) | G3 | base | Verified | [Oracle 1.0.0 accepted 2026-09-14](docs/requirements/sim_eval_01_review.md): 14 synthetic cases, nDCG@5 mean ≥0.90 / each ≥0.80, 8 hard invariants; 14 meta-tests PASS; owner Ask answered — accepted as-is, no changes. |
| [IMP-06](implementation_plan.md#imp-06) | SIM-EVAL-01, IMP-02 | base | Ready | Зависимости выполнены. Ожидается: Frozen comparison report и policy version |
