...
| [IMP-05](implementation_plan.md#imp-05) | IMP-04 | base | In progress | [Revalidation 2026-09-14 UTC](docs/requirements/imp_05_revalidation.md): 50 public checks на 38 играх; 35 fixture/browser checks; найден и исправлен overflow длинного названия на mobile. Candidate ожидает hosted CI и public smoke исправленной immutable сборки. |
