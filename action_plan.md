...
| [IMP-03](implementation_plan.md#imp-03) | IMP-02 | base | Verified | [Selector/scheduler/lease evidence](docs/requirements/imp_03_review.md); два реальных последовательных hourly-запуска, restart, найденный и исправленный live-баг canonical-проверки |
